...
# have made a temporary list  with date , predicted values and country_name		
tempbase = np.hstack((dbase[:,:1],dbase[:,5:6]))
tempbase = np.hstack((tempbase,dbase[:,6:7]))
tempbase = np.hstack((tempbase,dbase[:,7:8]))		
